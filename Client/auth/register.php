...
<body>
  <div id="container" class="regCont">
    ...
    <div id="socialmedia">
      ...
      <div id="Facebook" class="icons">F</div>
      <div class="shortLine"></div>
      <div id="Email" class="icons">E</div>
      <div class="shortLine"></div>
      <div id="Linkedin" class="icons">L</div>
      <div class="shortLine"></div>
      <div id="Instagram" class="icons">I</div>
      <div class="longLine"></div>
    </div>
    <div id="loginform">
      <form method="post" class="shadow" action="../../Server/Auth.php">
        <div id="inputfields" class="register">
          ...
          <div class="input-box">
            ...
            <div class="password">
              <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="icon" onclick="showPassword()">
