...
<body>
  <div id="container" class="regCont">
    <div class="rightDiv">
      <h1>E-NoteBook</h1>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias nostrum dolorem unde incidunt, natus cupiditate!</p>
    </div>
    ...
    <div id="socialmedia">
      ...
      <div id="Instagram" class="icons">
        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path d="M14.19 0H5.81C2.17 0 0 2.17 0 5.81V14.18C0 17.83 2.17 20 5.81 20H14.18C17.82 20 19.99 17.83 19.99 14.19V5.81C20 2.17 17.83 0 14.19 0ZM10 13.88C7.86 13.88 6.12 12.14 6.12 10C6.12 7.86 7.86 6.12 10 6.12C12.14 6.12 13.88 7.86 13.88 10C13.88 12.14 12.14 13.88 10 13.88ZM15.92 4.88C15.87 5 15.8 5.11 15.71 5.21C15.61 5.3 15.5 5.37 15.38 5.42C15.198 5.49725 14.9971 5.51853 14.803 5.48113C14.6089 5.44372 14.4303 5.34933 14.29 5.21C14.2 5.11 14.13 5 14.08 4.88C14.0286 4.75982 14.0015 4.63069 14 4.5C14 4.37 14.03 4.24 14.08 4.12C14.13 3.99 14.2 3.89 14.29 3.79C14.52 3.56 14.87 3.45 15.19 3.52C15.26 3.53 15.32 3.55 15.38 3.58C15.44 3.6 15.5 3.63 15.56 3.67C15.61 3.7 15.66 3.75 15.71 3.79C15.8 3.89 15.87 3.99 15.92 4.12C15.97 4.24 16 4.37 16 4.5C16 4.63 15.97 4.76 15.92 4.88Z" fill="rgb(71, 85, 105)" />
        </svg>
        ...
        <div id="inputfields" class="register">
          ...
          <div class="input-box">
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.30737 0.443001C9.36824 0.443001 10.3857 0.864428 11.1358 1.61457C11.8859 2.36472 12.3074 3.38213 12.3074 4.443C12.3074 5.50387 11.8859 6.52128 11.1358 7.27143C10.3857 8.02157 9.36824 8.443 8.30737 8.443C7.24651 8.443 6.22909 8.02157 5.47895 7.27143C4.7288 6.52128 4.30737 5.50387 4.30737 4.443C4.30737 3.38213 4.7288 2.36472 5.47895 1.61457C6.22909 0.864428 7.24651 0.443001 8.30737 0.443001ZM8.30737 10.443C12.7274 10.443 16.3074 12.233 16.3074 14.443V16.443H0.307373V14.443C0.307373 12.233 3.88737 10.443 8.30737 10.443Z" fill="black" />
            </svg>
          ...
          <div class="input-box">
            ...
            <div class="password">
              <svg id="showIcon" width="17" height="17" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" onclick="eyeOpen()">
                ...
                <path d="M0 8C0 8 3 2.5 8 2.5C13 2.5 16 8 16 8C16 8 13 13.5 8 13.5C3 13.5 0 8 0 8ZM8 11.5C8.92826 11.5 9.8185 11.1313 10.4749 10.4749C11.1313 9.8185 11.5 8.92826 11.5 8C11.5 7.07174 11.1313 6.1815 10.4749 5.52513C9.8185 4.86875 8.92826 4.5 8 4.5C7.07174 4.5 6.1815 4.86875 5.52513 5.52513C4.86875 6.1815 4.5 7.07174 4.5 8C4.5 8.92826 4.86875 9.8185 5.52513 10.4749C6.1815 11.1313 7.07174 11.5 8 11.5Z" fill-opacity="0.8" />
              </svg>
              <svg id="hideIcon" width="17" height="18" viewBox="0 0 15 17" xmlns="http://www.w3.org/2000/svg" onclick="eyeClose()">
