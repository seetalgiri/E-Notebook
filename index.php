...
$res_faculty = mysqli_query($con, $sql_faculty);
            ...
            <svg width='14' height='15' viewBox='0 0 16 18' xmlns='http://www.w3.org/2000/svg'>
                <path d='M12 6C12 8.21 10.21 10 8 10C5.79 10 4 8.21 4 6L4.11 5.06L1 3.5L8 0L15 3.5V8.5H14V4L11.89 5.06L12 6ZM8 12C12.42 12 16 13.79 16 16V18H0V16C0 13.79 3.58 12 8 12Z' />
                                ...
                                while ($row = mysqli_fetch_assoc($res_faculty)) {
                                    ...
                                    echo '<li class="selectSreamradio">';
                                    echo ($news == $streamValue) ? "<input type='radio' id='$streamId' name='stream' value='$streamValue' onchange='updateURL(this.value)' checked>" : "<input type='radio' id='$streamId' name='stream' value='$streamValue' onchange='updateURL(this.value)'>";
                                    echo "<label class='btn btn-default' for='$streamId'><span>" . $row['faculty_name'] . "</span>
                <svg width='14' height='15' viewBox='0 0 16 18' xmlns='http://www.w3.org/2000/svg'>
                    <path d='M12 6C12 8.21 10.21 10 8 10C5.79 10 4 8.21 4 6L4.11 5.06L1 3.5L8 0L15 3.5V8.5H14V4L11.89 5.06L12 6ZM8 12C12.42 12 16 13.79 16 16V18H0V16C0 13.79 3.58 12 8 12Z' />
                </svg></label>";
                                    echo '</li>';
                ...
                <!-- for each post  -->
                <form action="../../../Server/newsfeed.php">
                    <?php while ($row = mysqli_fetch_assoc($res_news)) { ?>
                        <div id="eachPost" class="shadow">
                            ...
                            <?php echo '<div id="contentDIv">' . $row['postdes'] . '</div>'; ?>
...
<<<<<<< HEAD
                    <div class="crossModal" onclick="modalClose()">X</div>
=======
...
=======
        ...
        shareDiv.addEventListener("click", handleShare);

        // Function to handle share functionality
        function handleShare() {
            // Get the post URL or any necessary data
            var postUrl = "<your_post_url>"; // Replace with the actual post URL

            // Open Facebook share dialog
            var facebookShareUrl = "https://www.facebook.com/" + encodeURIComponent(postUrl);
            window.open(facebookShareUrl, "_blank");

            // Open Instagram share dialog (for mobile devices)
            var instagramShareUrl = "instagram" + encodeURIComponent(postUrl);
