      ...
      <div id="dynamicContent">
        ...
        <div id="eachPost" class="shadow">
          <div id="contentdev">
            ...
            <div id="contentDIv">
              <div>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis, neque aspernatur? Nemo dolorum quasi
                dolorem error! Suscipit consectetur id eligendi quisquam sapiente enim minima. Sed fuga asperiores ipsam
                id atque nam vel officiis, iusto, sit facilis repellat quis blanditiis, odio temporibus tempora illum
            ...
            <div>
                ...
                <div class="eachcomment">
                  <div class="commentcontent">
                    ...
                    <div class="commentdata">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam, quo sed. Rem vel officia, quae
              ...
              <div id="post" class="shadow">
                <div id="userPost">G</div>
                <input type="text" name="search" class="shadow" id="createPost" placeholder="Post Comment"
                  autocomplete="off">
                <svg width="19" height="16" viewBox="0 0 19 16" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 16V10L8 8L0 6V0L19 8L0 16Z" />
                </svg>
