...
$querytotalnumberROw = "SELECT COUNT(*) as total FROM notes WHERE note_category = 'prevqn'";
...
// get data 
$sqlNote = "SELECT * FROM notes WHERE note_category = 'prevqn' LIMIT $offset, $recordsPerPage";
...
if (isset($_GET['facultyid'], $_GET['subject']) && (isset($_GET['sem']) || isset($_GET['year']))) {
    ...
    if (strlen($facultyId) > 0) {
        ...
        $sqlNote = "SELECT * FROM notes WHERE note_category = 'prevqn'";
...
if (isset($_GET['search'])) {
    ...
    if (!empty($search)) {
        ...
        $sqlNote = "SELECT * FROM notes WHERE note_category = 'prevqn' AND note_name LIKE '%$search%' LIMIT $offset, $recordsPerPage";
        $resultNotes = mysqli_query($con, $sqlNote);
        $totalRowNumber = mysqli_num_rows($resultNotes);
        $totalPages = ceil($totalRowNumber / $recordsPerPage);
    } else {
...
<head>
    ...
    <title>E-Notebook Previous Year Question</title>
    <!-- ==================== CSS Imported ======================== -->
    <!-- for globala.css  -->
                ...
                <div class="filtersec shadow">
                    ...
                    <div class="filerContentfixed">
                        ...
                        <div class="headings mt-20px">
                            <div class="heading shadow">Filter Question:</div>
                        </div>
                        ...
                        <div class="disremember">
                            For better quality previous year question, choose stream, semester or year, and
                ...
                <div id="actualNote" class="bl-thin">
                    <div class="headingsChapter">
                        ...
                        <form id="searchNotes" class="shadow">
                            ...
                            <input type="text" name="search" id="search" placeholder="Search previous question..." autocomplete="off" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>" />
