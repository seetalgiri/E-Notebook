    ...
    <nav id="topnav">
        ...
        <div id="sideContents">
            <ul>
                ...
                <li id="broom">
                    <svg width="22" height="22" onclick="pageLoad()" style="cursor: pointer;" viewBox="0 0 19 19"
                ...
                <li class="posrel">
                    <a>
                        <svg id="notbtn" <?php echo ($countREQPost > 0) ? ' onclick="NotbtnClk()"' : '' ?> width="25"
                            height="25" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <path
                                ...
                                <text x="22" y="8" text-anchor="middle" alignment-baseline="central" fill="white"
                                    font-size="11px">
                ...
                <li id="adminProfilemainDiv">
                    <div id="adminProfile">
                        <svg id="adminProfile1" width="35" height="40" viewBox="0 0 21 21"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div id="listItemsAdminPp" class="shadow">
                        <ul id='adminppLink'>
                            ...
                            <li>
                                <a href="/e_notebook/index.php" target="blank">
                                    <span>Home</span> <svg width="18" height="22" viewBox="0 0 20 17"
                                        xmlns="http://www.w3.org/2000/svg">
