...
<body>
                    ...
                    <div class="shadow userCard">
                        <div class="hambar">
                            ...
                            <div class="hamlist shadow-lg listHambar">
                                <ul class="hambarul">
                                    <li class="border-b" onclick="btnClicked()">Add-Admin</li>
                                    <li onclick="btnClicked()">Delete User</li>
                                </ul>
                            </div>
                        </div>
    ...
    <script>
        ...
        const toggleHamlist = hamlistElement => {
            if (hamlistElement.style.display === 'none' || hamlistElement.style.display === '') {
                hideAllHamlist();
